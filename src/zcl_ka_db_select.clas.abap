CLASS zcl_ka_db_select DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_ka_db_select IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

    DATA airport_from_id TYPE /DMO/airport_from_id. " Interesting type!!
...
**********************************************************************
    ...
    out->write( |Flight SQ 0001 flies from {  airport_from_id } to { airport_to_id  }| ).
