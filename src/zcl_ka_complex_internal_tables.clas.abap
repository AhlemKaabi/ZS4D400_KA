CLASS zcl_ka_complex_internal_tables DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_ka_complex_internal_tables IMPLEMENTATION.
...
**********************************************************************
    ...
    out->write(  `------------------------------------------` ).
    out->write(  `Example 2-2:` ).
    out->write( connections_2 ).
    ...
    out->write(  `------------------------------------------` ).
    out->write(  `Example 2-3:` ).
    out->write( connections_3 ).
    ...
    out->write(  `------------------------------------------` ).
    out->write(  `Example 2-4:` ).
    out->write( connections_4 ).
