CLASS zcl_ka_functional_methods DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_ka_functional_methods IMPLEMENTATION.
...
*        out->write( 'writing line in a loop' ).
*        out->write( line ).
      ENDLOOP.
    ...
    ELSE.
      ...
      out->write( 'connection->get_output(  ) is INITIAL' ).
